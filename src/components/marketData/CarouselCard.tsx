...
const CarouselCard: React.FC<CarouselCardProps> = ({ item }) => {
  ...
  const [coin1, coin2] = (item.market.name || "").split(/[-/]/);
    ...
    <div className='w-[250px] sm:w-[330px] flex justify-between items-start ml-3 bg-background-900 dark:bg-background-100 cardShadowBor px-4 py-2 sm:py-3 rounded-[16px]'>
      ...
      <div className='flex flex-col gap-2'>
        <div className='flex justify-center items-center'>
          {coinLogo1URL && <Image src={coinLogo1URL} alt={coin1} width={24} height={24} className='object-fill z-10' />}
          {coinLogo2URL && <Image src={coinLogo2URL} alt={coin2} width={24} height={24} className='object-fill -ml-3 z-0' />}
